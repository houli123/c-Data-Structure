...
| ---------------------- | ------------------------------------------- |
| Char                   | **-127** - **128**                          |
| Int（有符号）2字节16位 | **-32768 - 32767 = -215 - 215 - 1**         |
| Int（无符号）2字节16位 | 0 - **65535（216 - 1）**                    |
| Int（有符号）4字节32位 | -2147483648 - **2147483647** = -231 - 231-1 |
| Int（无符号）4字节32位 | -4294967296 - **4294967295** = -232 - 232-1 |
...
| \* 2^n^ | x  << n           |                        |
| / 2^n^  | x >> n            |                        |
| Tmin    | 1/-1 << 31        | -2147483648            |
| Tmax    | 0xffffffff >> 1   | 2147483647             |
|         | ~0u >> 1          |                        |
| isTmax  | !(x ^ (~0u >> 1)) |                        |
